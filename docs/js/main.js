...
async function main() {
  ...
  markersGeoJsonSource.forEach(markerSource => {
    ...
    marker.onClick = e => {
      console.log('click');
      _sliders_js__WEBPACK_IMPORTED_MODULE_0__.pointsSlider.slideTo(index);
    };
    groupMarkers.push(marker);
    map.addChild(marker);
  });
  _sliders_js__WEBPACK_IMPORTED_MODULE_0__.pointsSlider.on('slideChange', swiper => {
    groupMarkers.forEach(marker => {
      marker.update({
        color: defaultColor
      });
    });
    groupMarkers[swiper.activeIndex].update({
      color: activeColor
    });
  });
}
...
swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper.use([swiper_modules__WEBPACK_IMPORTED_MODULE_1__.FreeMode, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.EffectFade, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Grid]);
const techSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper('.tech__slider', {
  slidesPerView: 'auto',
  spaceBetween: 20,
  centeredSlides: true
});
...
const roadsSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper('.roads__slider', {
  slidesPerView: 1,
  spaceBetween: 30,
  loop: true,
  navigation: {
...
const rButtonslider = new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper('.roads__wrapper', {
  slidesPerView: 2,
  grid: {
    fill: 'row',
    rows: 2
...
(0,_functions_validate_forms_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.modal__form', rules1, checks, afterForm);
